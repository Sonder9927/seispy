...
def cut_events_binary(
    ...
    with ProcessPoolExecutor(max_workers=max_workers) as executor:
        futures = {
            executor.submit(
                _cut_station, index, station, mktraceiodb, cutevent,
                event_file, time_window, dest_dir,
            )
...
def _cut_station(index, station, mktraceiodb, cutevent, event_file,
                 time_window, dest_dir):
