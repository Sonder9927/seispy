"""Reliable workflow runs, output commits, reports, and logs."""
...
class BatchSummary(ABC):
    ...
    Every concrete batch summary additionally exposes ``total``, ``succeeded``,
    ``failed``, and ``issue_samples``. Domain-specific counters may supplement
    these names but never replace them.
    """
