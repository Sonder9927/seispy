"""Phase-preserving waveform decimation workflows."""
...
class DecimationSummary(BatchSummary):
    ...
    This class is returned by :func:`decimate_waveforms`; applications
...
def decimate_waveforms(
    ...
    *,
    ...
    with BatchRun(
        ...
        for error in summary.issue_samples:
            run.error(
